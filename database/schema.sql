...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Des 2025 pada 06.09
...
--
-- Struktur dari tabel `cafe_settings`
--
...
--
-- Dumping data untuk tabel `cafe_settings`
--
...
--
-- Struktur dari tabel `customer_favorites`
--
...
--
-- Struktur dari tabel `material_batches`
--
...
--
-- Dumping data untuk tabel `material_batches`
------------------------------------------------------

--
-- Struktur dari tabel `material_cost_history`
--
...
--
-- Struktur dari tabel `material_usage_log`
--
...
--
-- Dumping data untuk tabel `material_usage_log`
...
--
-- Struktur dari tabel `menu_engineering_data`
--
...
CREATE TABLE `menu_items` (
  ...
  `cost_per_unit` decimal(10,2) DEFAULT 0.00 COMMENT 'Cost per unit for profit margin calculations',
...
--
-- Struktur dari tabel `order_item_variations`
--
...
--
-- Dumping data untuk tabel `order_item_variations`----------------------------------------------

--
-- Struktur dari tabel `order_notifications`
--
...
--
-- Dumping data untuk tabel `order_notifications`
--
 --------------------------------------------------------
...
--
-- Struktur dari tabel `price_change_notifications`
--
...
--
-- Struktur dari tabel `product_addon_assignments`
--
...
--
-- Dumping data untuk tabel `product_addon_assignments`
--

------------------------------------------------------

--
-- Struktur dari tabel `product_analytics_cache`
--
...
--
-- Struktur dari tabel `product_analytics_settings`
--

CREATE TABLE `product_analytics_settings` (
  `setting_id` int(11) NOT NULL,
  `cafe_id` int(11) NOT NULL,
  `low_demand_threshold` int(11) DEFAULT 10 COMMENT 'Minimum units sold per week to be considered low-demand',
  `high_demand_threshold` int(11) DEFAULT 50 COMMENT 'Minimum units sold per week to be considered high-demand',
  `trend_period_weeks` int(11) DEFAULT 4 COMMENT 'Number of weeks to analyze for trends',
  `profit_margin_warning` decimal(5,2) DEFAULT 20.00 COMMENT 'Profit margin percentage below which to warn',
  `auto_recommendations_enabled` tinyint(1) DEFAULT 1,
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data untuk tabel `product_analytics_settings`
--

--
-- Struktur dari tabel `product_pricing`
--
...
--
-- Dumping data untuk tabel `product_pricing`
--
...
--
-- Dumping data untuk tabel `product_recipes`
-------------------------------------------------------
...
CREATE TABLE `product_recommendations` (
  ...
  `description` text DEFAULT NULL,
  `suggested_value` decimal(10,2) DEFAULT NULL COMMENT 'For discounts, price changes, etc.',
...
--
-- Struktur dari tabel `product_variation_assignments`
--
...
--
-- Dumping data untuk tabel `product_variation_assignments`
--
...
--
-- Struktur dari tabel `sub_recipes`
--
...
--
-- Struktur dari tabel `sub_recipe_ingredients`
--
...
--
-- Struktur dari tabel `variation_options`
--
...
--
-- Dumping data untuk tabel `variation_options`
--
---------------------------------------------------
...
--
-- Struktur dari tabel `voucher_performance`
--
...
--
-- Struktur dari tabel `voucher_product_impact`
--
...
--
-- Struktur dari tabel `voucher_profit_impact`
--
...
--
-- Struktur dari tabel `voucher_usage_log`
--
...
--
-- Dumping data untuk tabel `voucher_usage_log`
--
...
--
-- Indeks untuk tabel `cafe_settings`
--
...
--
-- Indeks untuk tabel `customer_favorites`
--
...
--
-- Indeks untuk tabel `material_batches`
--
...
--
-- Indeks untuk tabel `material_cost_history`
--
...
--
-- Indeks untuk tabel `material_usage_log`
--
...
--
-- Indeks untuk tabel `menu_engineering_data`
--
...
--
-- Indeks untuk tabel `order_item_variations`
--
...
--
-- Indeks untuk tabel `order_notifications`
--
...
--
-- Indeks untuk tabel `price_change_notifications`
--
...
--
-- Indeks untuk tabel `product_addon_assignments`
--
...
--
-- Indeks untuk tabel `product_analytics_cache`
--
...
--
-- Indeks untuk tabel `product_analytics_settings`
--
...
--
-- Indeks untuk tabel `product_pricing`
--
...
--
-- Indeks untuk tabel `product_variation_assignments`
--
...
--
-- Indeks untuk tabel `sub_recipes`
--
...
--
-- Indeks untuk tabel `sub_recipe_ingredients`
--
...
--
-- Indeks untuk tabel `variation_options`
--
...
--
-- Indeks untuk tabel `voucher_performance`
--
...
--
-- Indeks untuk tabel `voucher_product_impact`
--
...
--
-- Indeks untuk tabel `voucher_profit_impact`
--
...
--
-- Indeks untuk tabel `voucher_usage_log`
--
...
--
-- AUTO_INCREMENT untuk tabel `cafe_settings`
--
ALTER TABLE `cafe_settings`
...
--
-- AUTO_INCREMENT untuk tabel `customer_favorites`
--
ALTER TABLE `customer_favorites`
...
--
-- AUTO_INCREMENT untuk tabel `material_batches`
--
ALTER TABLE `material_batches`
  MODIFY `batch_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `material_cost_history`
--
ALTER TABLE `material_cost_history`
  MODIFY `history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `material_usage_log`
--
ALTER TABLE `material_usage_log`
...
--
-- AUTO_INCREMENT untuk tabel `menu_engineering_data`
--
ALTER TABLE `menu_engineering_data`
...
--
-- AUTO_INCREMENT untuk tabel `order_item_variations`
--
ALTER TABLE `order_item_variations`
  MODIFY `order_item_variation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=149;

--
-- AUTO_INCREMENT untuk tabel `order_notifications`
--
ALTER TABLE `order_notifications`
...
--
-- AUTO_INCREMENT untuk tabel `price_change_notifications`
--
ALTER TABLE `price_change_notifications`
...
--
-- AUTO_INCREMENT untuk tabel `product_addon_assignments`
--
ALTER TABLE `product_addon_assignments`
  MODIFY `assignment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT untuk tabel `product_analytics_cache`
--
ALTER TABLE `product_analytics_cache`
  MODIFY `cache_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `product_analytics_settings`
--
ALTER TABLE `product_analytics_settings`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `product_pricing`
--
ALTER TABLE `product_pricing`
...
--
-- AUTO_INCREMENT untuk tabel `product_variation_assignments`
--
ALTER TABLE `product_variation_assignments`
...
--
-- AUTO_INCREMENT untuk tabel `sub_recipes`
--
ALTER TABLE `sub_recipes`
  MODIFY `sub_recipe_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `sub_recipe_ingredients`
--
ALTER TABLE `sub_recipe_ingredients`
...
--
-- AUTO_INCREMENT untuk tabel `variation_options`
--
ALTER TABLE `variation_options`
...
--
-- AUTO_INCREMENT untuk tabel `voucher_performance`
--
ALTER TABLE `voucher_performance`
  MODIFY `performance_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `voucher_product_impact`
--
ALTER TABLE `voucher_product_impact`
  MODIFY `impact_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `voucher_profit_impact`
--
ALTER TABLE `voucher_profit_impact`
  MODIFY `impact_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `voucher_usage_log`
--
ALTER TABLE `voucher_usage_log`
...
--
-- Ketidakleluasaan untuk tabel `cafe_settings`
--
ALTER TABLE `cafe_settings`
...
--
-- Ketidakleluasaan untuk tabel `customer_favorites`
--
ALTER TABLE `customer_favorites`
...
--
-- Ketidakleluasaan untuk tabel `material_usage_log`
--
ALTER TABLE `material_usage_log`
...
--
-- Ketidakleluasaan untuk tabel `menu_engineering_data`
--
ALTER TABLE `menu_engineering_data`
...
--
-- Ketidakleluasaan untuk tabel `order_item_variations`
--
ALTER TABLE `order_item_variations`
...
--
-- Ketidakleluasaan untuk tabel `order_notifications`
--
ALTER TABLE `order_notifications`
...
--
-- Ketidakleluasaan untuk tabel `product_addon_assignments`
--
ALTER TABLE `product_addon_assignments`
...
--
-- Ketidakleluasaan untuk tabel `product_analytics_cache`
--
ALTER TABLE `product_analytics_cache`
...
--
-- Ketidakleluasaan untuk tabel `product_variation_assignments`
--
ALTER TABLE `product_variation_assignments`
...
--
-- Ketidakleluasaan untuk tabel `variation_options`
--
ALTER TABLE `variation_options`
...
--
-- Ketidakleluasaan untuk tabel `voucher_performance`
--
ALTER TABLE `voucher_performance`
...
--
-- Ketidakleluasaan untuk tabel `voucher_product_impact`
--
ALTER TABLE `voucher_product_impact`
...
--
-- Ketidakleluasaan untuk tabel `voucher_profit_impact`
--
ALTER TABLE `voucher_profit_impact`
...
--
-- Ketidakleluasaan untuk tabel `voucher_usage_log`
--
ALTER TABLE `voucher_usage_log`
