...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $secondary_color = sanitizeInput($_POST['secondary_color'] ?? '#252525');
    $accent_color = sanitizeInput($_POST['accent_color'] ?? '#3A3A3A');
...
function resetColors() {
    if (confirm('Reset to default black and white theme?')) {
        document.getElementById('primary_color').value = '#FFFFFF';
        document.getElementById('primary_color_text').value = '#FFFFFF';
        document.getElementById('secondary_color').value = '#252525';
        document.getElementById('secondary_color_text').value = '#252525';
        document.getElementById('accent_color').value = '#3A3A3A';
        document.getElementById('accent_color_text').value = '#3A3A3A';
        updatePreview();
    }
}
